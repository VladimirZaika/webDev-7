    ...
    <section class="section section__article flex__center">
        <div class="breadcrumb__wrap flex__center">
            <ul class="breadcrumb">
                ...
                <li class="current__page">Блог</li>
                <li class="current__page" id="article-name"></li>
            </ul>
        </div>
        <article class="article flex__center pt-from-24-to-64">
            <div class="article__header">
                <a class="go-to__new-blank reverse flex__center" href="#">Все статьи<span class="link__arrow flex__center"><span>.</span></span></a>
                <div class="info__wrap info__article flex__center mt-24">
                    <time class="date date__news">12.10.2020</time>
                    <span class="news__category--info flex__center ml-48 active" type="button">Офисный переезд</span>
                    <span class="news__category--info flex__center ml-48" type="button">Квартирный переезд</span>
                </div>
                <h1 class="title mt-from-8-to-16" id="title-name">Как устроить переезд с гарантированной стоимостью?</h1>
            </div>
            <div class="article__body flex__center mt-from-24-to-56">
                ...
                <div class="article__content mt-from-24-to-56"">
...
<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/article.js"></script>
<?php
get_footer();
?>